  ...
  HTTP: {
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              шифрования (<b>симетричное</b>, <b>ассиметричное</b>,{' '}
              <b>хеш-функции</b>)
            </li>
            <li>
    ...
    Идемпотентность: {
      ...
      jsx: (
        <div>
          <p>
            <b>Идемпотентность</b> - это свойство операции, при котором ее
    ...
    CRUD: {
      ...
      jsx: (
        <div>
          <p>
            <b>CRUD</b> - это акроним, который описывает четыре базовые
            операции:
          </p>
          <ul>
            <li>C — Create</li>
