const Typescript = {
  Typescript: {
    ...
    'Intersection type':                  {
      ...
      jsx:   (
               <div>
                 <p><b>Intersection type</b> - тип, который создается путем объединения нескольких типов с
                   использованием оператора <b>"&"</b></p>
                 <pre>
    ...
    'Литералы':                           {
      ...
      jsx:   (
               <div>
                 <p><b>Литералы</b> - позволяют указать конкретное значение, а не просто тип данных, как это делают
                   обычные типы.</p>
                 <pre>
            <div className="numbers">
              <code className="codeNumber">1</code>
            ...
            <code>
              <code>let <b>myString</b>: "hello" = "hello";</code>
                 ...
                 <p><b>Шаблонные литеральные типы</b>- позволяют создавать строковые литералы на основе других типов или
                   значений.</p>
                 <pre>
            <div className="numbers">
              <code className="codeNumber">1</code>
    ...
    'Assertion Function with Type Guard': {
      ...
      jsx:   (
               <div>
                 <ul>
                   Assertion Function with Type Guard (утверждающая функция с защитником типа) — это специальная
                   функция, которая:
    ...
    'Перегрузка функций':                 {
      ...
      jsx:   (
               <div>
                 <p><b>Перегрузка функций</b> - позволяет создавать несколько версий одной функции, каждая из которых
                   принимает разные типы или количество аргументов, обеспечивая большую гибкость и удобство
                   использования.</p>
                 <pre>
          <div className="numbers">
            <code className="codeNumber">1</code>
    ...
    'Условные типы':                      {
      ...
      jsx:   (
               <div>
                 <p><b>Условные типы</b> - это особенный синтаксис для работы с типами, позволяющий определять типы
                   данных на основе условий.</p>
                 <pre>
            <div className="numbers">
              <code className="codeNumber">1</code>
            </div>
    ...
    'infer':                              {
      ...
      jsx:   (
               <div>
                 <p><b>infer</b> работает в связке с условными типами, которые позволяют создавать типы, зависящие от
                   других типов.</p>
                 <p>Когда вы используете <b>infer</b> в условном типе, TypeScript пытается вывести конкретный тип из
                   заданного типа. Например, если вы работаете с массивом, <b>infer</b> может вывести тип элементов
                   массива.</p>
                 <pre>
          <div className="numbers">
             <code className="codeNumber">1</code>
    ...
    'Рекурсивные типы':                   {
      ...
      jsx:   (
               <div>
                 <p><b>Рекурсивные типы</b> позволяют описывать типы, которые ссылаются на самих себя в своем
                   определении, это достигается путем использования типа внутри его собственного определения, что
                   позволяет TypeScript обрабатывать сложные вложенные структуры</p>
                 <pre>
            <div className="numbers">
              <code className="codeNumber">1</code>
                <code className="codeNumber">2</code>
            ...
            <code>
              <code><b>type</b> NestedValue = {'{'}</code>
              <code>{'  '}value: <b>string</b>;</code>
              <code>{'  '}next?: NestedValue;</code>
              <code>{'}'};</code>
              <code>{'  '}</code>
              <code><b>const</b> list: NestedValue = {'{'}</code>
              <code>{'  '}value: <b>'a'</b>,</code>
              <code>{'  '}next: {'{'}</code>
              <code>{'    '}value: <b>'b'</b>,</code>
              <code>{'    '}next: {'{'}</code>
              <code>{'      '}value: <b>'c'</b></code>
              <code>{'    '}{'}'}</code>
              <code>{'  '}{'}'}</code>
              <code>{'}'};</code>
            </code>
